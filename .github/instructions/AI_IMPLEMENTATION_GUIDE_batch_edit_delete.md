...
## 🎯 Feature Overview
**Feature ID:** `logging.batch_edit_delete`
**Title:** Batch Edit & Delete
**Epic:** logging (LOGGING) | **Priority:** P2 | **Order:** 6
...
You are tasked with implementing **Batch Edit & Delete** (logging.batch_edit_delete) as part of the AshTrail mobile application.
...
```
lib/features/batch_edit_delete/
...
test/features/batch_edit_delete/         # Comprehensive test coverage
...
### ✅ Acceptance Criteria
  - **Must:** Multi-select in table; apply tag add/remove or delete.
  - **Must:** Confirms destructive operations.
...
#### 1.1 Define Entities
```dart
// lib/features/batch_edit_delete/domain/entities/batch_edit_delete_entity.dart
import 'package:freezed_annotation/freezed_annotation.dart';

part 'batch_edit_delete_entity.freezed.dart';

@freezed
class BatchEditDeleteEntity with _$BatchEditDeleteEntity {
  const factory BatchEditDeleteEntity({
    required String id,
    required DateTime createdAt,
    DateTime? updatedAt,
    // Add your domain fields here based on requirements
  }) = _BatchEditDeleteEntity;
...
```dart
// lib/features/batch_edit_delete/domain/repositories/batch_edit_delete_repository.dart
import 'package:dartz/dartz.dart';
import '../entities/batch_edit_delete_entity.dart';
import '../../../../core/error/failures.dart';

abstract class BatchEditDeleteRepository {
  Future<Either<AppFailure, List<BatchEditDeleteEntity>>> getAll();
  Future<Either<AppFailure, BatchEditDeleteEntity>> getById(String id);
  Future<Either<AppFailure, BatchEditDeleteEntity>> create(BatchEditDeleteEntity entity);
  Future<Either<AppFailure, BatchEditDeleteEntity>> update(BatchEditDeleteEntity entity);
...
```dart
// lib/features/batch_edit_delete/domain/usecases/get_batch_edit_deletes_usecase.dart
import 'package:dartz/dartz.dart';
import 'package:injectable/injectable.dart';
import '../entities/batch_edit_delete_entity.dart';
import '../repositories/batch_edit_delete_repository.dart';
import '../../../../core/error/failures.dart';
import '../../../../core/usecases/usecase.dart';

@injectable
class GetBatchEditDeletesUseCase implements UseCase<List<BatchEditDeleteEntity>, NoParams> {
  const GetBatchEditDeletesUseCase(this._repository);
  
  final BatchEditDeleteRepository _repository;
  
  @override
  Future<Either<AppFailure, List<BatchEditDeleteEntity>>> call(NoParams params) {
...
```dart
// lib/features/batch_edit_delete/data/models/batch_edit_delete_model.dart
import 'package:freezed_annotation/freezed_annotation.dart';
import 'package:isar/isar.dart';
import '../../domain/entities/batch_edit_delete_entity.dart';

part 'batch_edit_delete_model.freezed.dart';
part 'batch_edit_delete_model.g.dart';

@freezed
@Collection()
class BatchEditDeleteModel with _$BatchEditDeleteModel {
  const factory BatchEditDeleteModel({
    @JsonKey(name: 'id') required String id,
    @JsonKey(name: 'created_at') required DateTime createdAt,
    @JsonKey(name: 'updated_at') DateTime? updatedAt,
  }) = _BatchEditDeleteModel;
  
  factory BatchEditDeleteModel.fromJson(Map<String, dynamic> json) =>
      _$BatchEditDeleteModelFromJson(json);
  
  BatchEditDeleteEntity toEntity() => BatchEditDeleteEntity(
    id: id,
    createdAt: createdAt,
    updatedAt: updatedAt,
  );
  
  factory BatchEditDeleteModel.fromEntity(BatchEditDeleteEntity entity) =>
      BatchEditDeleteModel(
        id: entity.id,
...
```dart
// lib/features/batch_edit_delete/presentation/providers/batch_edit_delete_providers.dart
import 'package:riverpod_annotation/riverpod_annotation.dart';
import '../../domain/entities/batch_edit_delete_entity.dart';
import '../../domain/usecases/get_batch_edit_deletes_usecase.dart';
import '../../../../core/usecases/usecase.dart';
import '../../../../core/di/injection.dart';

part 'batch_edit_delete_providers.g.dart';

@riverpod
class BatchEditDeleteListNotifier extends _BatchEditDeleteListNotifier {
  @override
  Future<List<BatchEditDeleteEntity>> build() async {
    final useCase = getIt<GetBatchEditDeletesUseCase>();
...
- Target ≥85% overall coverage for new `batch_edit_delete` feature code
...
#### Unit Tests
```dart
// test/features/batch_edit_delete/domain/usecases/get_batch_edit_deletes_usecase_test.dart
import 'package:dartz/dartz.dart';
import 'package:flutter_test/flutter_test.dart';
import 'package:mocktail/mocktail.dart';

void main() {
  group('GetBatchEditDeletesUseCase', () {
...
#### Widget Tests
```dart
// test/features/batch_edit_delete/presentation/screens/batch_edit_delete_screen_test.dart
...
void main() {
  testWidgets('displays loading state correctly', (tester) async {
    await tester.pumpWidget(
      ProviderScope(
        overrides: [
          batch_edit_deleteListNotifierProvider.overrideWith((ref) {
            return const AsyncValue.loading();
          }),
        ],
        child: const MaterialApp(home: BatchEditDeleteScreen()),
      ),
    );
...
flutter test --coverage test/features/batch_edit_delete/
...
python scripts/dev_assistant.py finalize-feature --feature-id logging.batch_edit_delete --dry-run
```
...
**Generated:** 2025-09-20T22:50:41.686192+00:00
