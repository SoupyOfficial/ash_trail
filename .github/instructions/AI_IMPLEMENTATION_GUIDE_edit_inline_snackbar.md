...
## 🎯 Feature Overview
**Feature ID:** `logging.edit_inline_snackbar`
**Title:** Inline Edit From Snackbar
**Epic:** logging (LOGGING) | **Priority:** P2 | **Order:** 5
...
You are tasked with implementing **Inline Edit From Snackbar** (logging.edit_inline_snackbar) as part of the AshTrail mobile application.
...
Fix minor mistakes immediately after creation.
...
```
lib/features/edit_inline_snackbar/
...
test/features/edit_inline_snackbar/         # Comprehensive test coverage
...
### ✅ Acceptance Criteria
  - **Must:** Snackbar expands to allow duration +/- buttons and notes field within undo window.
  - **Must:** Update cancels and replaces prior queued write if not yet synced.
...
#### 1.1 Define Entities
```dart
// lib/features/edit_inline_snackbar/domain/entities/edit_inline_snackbar_entity.dart
import 'package:freezed_annotation/freezed_annotation.dart';

part 'edit_inline_snackbar_entity.freezed.dart';

@freezed
class EditInlineSnackbarEntity with _$EditInlineSnackbarEntity {
  const factory EditInlineSnackbarEntity({
    required String id,
    required DateTime createdAt,
    DateTime? updatedAt,
    // Add your domain fields here based on requirements
  }) = _EditInlineSnackbarEntity;
...
```dart
// lib/features/edit_inline_snackbar/domain/repositories/edit_inline_snackbar_repository.dart
import 'package:dartz/dartz.dart';
import '../entities/edit_inline_snackbar_entity.dart';
import '../../../../core/error/failures.dart';

abstract class EditInlineSnackbarRepository {
  Future<Either<AppFailure, List<EditInlineSnackbarEntity>>> getAll();
  Future<Either<AppFailure, EditInlineSnackbarEntity>> getById(String id);
  Future<Either<AppFailure, EditInlineSnackbarEntity>> create(EditInlineSnackbarEntity entity);
  Future<Either<AppFailure, EditInlineSnackbarEntity>> update(EditInlineSnackbarEntity entity);
...
```dart
// lib/features/edit_inline_snackbar/domain/usecases/get_edit_inline_snackbars_usecase.dart
import 'package:dartz/dartz.dart';
import 'package:injectable/injectable.dart';
import '../entities/edit_inline_snackbar_entity.dart';
import '../repositories/edit_inline_snackbar_repository.dart';
import '../../../../core/error/failures.dart';
import '../../../../core/usecases/usecase.dart';

@injectable
class GetEditInlineSnackbarsUseCase implements UseCase<List<EditInlineSnackbarEntity>, NoParams> {
  const GetEditInlineSnackbarsUseCase(this._repository);
  
  final EditInlineSnackbarRepository _repository;
  
  @override
  Future<Either<AppFailure, List<EditInlineSnackbarEntity>>> call(NoParams params) {
...
```dart
// lib/features/edit_inline_snackbar/data/models/edit_inline_snackbar_model.dart
import 'package:freezed_annotation/freezed_annotation.dart';
import 'package:isar/isar.dart';
import '../../domain/entities/edit_inline_snackbar_entity.dart';

part 'edit_inline_snackbar_model.freezed.dart';
part 'edit_inline_snackbar_model.g.dart';

@freezed
@Collection()
class EditInlineSnackbarModel with _$EditInlineSnackbarModel {
  const factory EditInlineSnackbarModel({
    @JsonKey(name: 'id') required String id,
    @JsonKey(name: 'created_at') required DateTime createdAt,
    @JsonKey(name: 'updated_at') DateTime? updatedAt,
  }) = _EditInlineSnackbarModel;
  
  factory EditInlineSnackbarModel.fromJson(Map<String, dynamic> json) =>
      _$EditInlineSnackbarModelFromJson(json);
  
  EditInlineSnackbarEntity toEntity() => EditInlineSnackbarEntity(
    id: id,
    createdAt: createdAt,
    updatedAt: updatedAt,
  );
  
  factory EditInlineSnackbarModel.fromEntity(EditInlineSnackbarEntity entity) =>
      EditInlineSnackbarModel(
        id: entity.id,
...
```dart
// lib/features/edit_inline_snackbar/presentation/providers/edit_inline_snackbar_providers.dart
import 'package:riverpod_annotation/riverpod_annotation.dart';
import '../../domain/entities/edit_inline_snackbar_entity.dart';
import '../../domain/usecases/get_edit_inline_snackbars_usecase.dart';
import '../../../../core/usecases/usecase.dart';
import '../../../../core/di/injection.dart';

part 'edit_inline_snackbar_providers.g.dart';

@riverpod
class EditInlineSnackbarListNotifier extends _EditInlineSnackbarListNotifier {
  @override
  Future<List<EditInlineSnackbarEntity>> build() async {
    final useCase = getIt<GetEditInlineSnackbarsUseCase>();
...
- Target ≥85% overall coverage for new `edit_inline_snackbar` feature code
...
#### Unit Tests
```dart
// test/features/edit_inline_snackbar/domain/usecases/get_edit_inline_snackbars_usecase_test.dart
import 'package:dartz/dartz.dart';
import 'package:flutter_test/flutter_test.dart';
import 'package:mocktail/mocktail.dart';

void main() {
  group('GetEditInlineSnackbarsUseCase', () {
...
#### Widget Tests
```dart
// test/features/edit_inline_snackbar/presentation/screens/edit_inline_snackbar_screen_test.dart
...
void main() {
  testWidgets('displays loading state correctly', (tester) async {
    await tester.pumpWidget(
      ProviderScope(
        overrides: [
          edit_inline_snackbarListNotifierProvider.overrideWith((ref) {
            return const AsyncValue.loading();
          }),
        ],
        child: const MaterialApp(home: EditInlineSnackbarScreen()),
      ),
    );
...
flutter test --coverage test/features/edit_inline_snackbar/
...
python scripts/dev_assistant.py finalize-feature --feature-id logging.edit_inline_snackbar --dry-run
```
...
**Generated:** 2025-09-20T22:13:55.829727+00:00
**Complexity:** Moderate | **Epic:** logging | **Priority:** P2
