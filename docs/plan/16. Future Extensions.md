...
> **Status**: Not implemented in MVP. Export functionality is planned for future release.
...
> **Status**: Not implemented in MVP. Planned for future release.

#### 16.4.1 Overview

Potential future capability to attach user-defined tags or labels to log entries for categorization and filtering.

##### Responsibilities
- Allow users to create custom tags
- Associate one or more tags with log entries
- Enable filtering and searching by tags
- Support tag-based analytics and aggregation
...
- Tag (entity)
  ...
  - `color?: string`
  - `createdAt: DateTime`
- LogEntryTag (junction)
  - `logEntryId: string`
  - `tagId: string`

#### 16.4.3 Open Questions

- Are tags account-scoped or global?
	- Account-scoped (matches isolation model)
- Can tags be renamed or merged?
	- TBD
- How are tags represented in export formats?
	- CSV: comma-separated in dedicated column
	- JSON: array of tag objects
- Should tags support hierarchies or remain flat?
	- Start flat; hierarchy is future consideration

---

### 16.5 Automation

#### 16.5.1 Scheduled Summaries
