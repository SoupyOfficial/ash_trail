...
FilterPreset _$FilterPresetFromJson(Map<String, dynamic> json) => FilterPreset(
  ...
  includeTags:
      (json['includeTags'] as List<dynamic>?)?.map((e) => e as String).toList(),
  excludeTags:
      (json['excludeTags'] as List<dynamic>?)?.map((e) => e as String).toList(),
...
_$FilterPresetImpl _$$FilterPresetImplFromJson(
