// Use case for adding tags to multiple smoke logs in batch

import 'package:fpdart/fpdart.dart';
import '../../../../core/failures/app_failure.dart';
import '../repositories/logs_table_repository.dart';

class AddTagsToLogsBatchUseCase {
  final LogsTableRepository _repository;

  const AddTagsToLogsBatchUseCase({
  ...
  Future<Either<AppFailure, int>> call({
    ...
    return _repository.addTagsToLogsBatch(
      accountId: accountId,
