...
void main() {
  group('Feature ui.haptics_baseline', () {
    test(
      '1. Central utility exposes semantic haptic events: tap, success, warning, error, impact_light.',
      () async {
    ...
    test(
      '3. Haptics disabled automatically when Reduce Motion or system haptics disabled (if detectable) or via dev flag.',
      () async {
        // TODO: implement acceptance validation
      },
    );
